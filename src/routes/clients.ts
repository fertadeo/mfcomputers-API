 ...
 * @access Public
 * @body { client_type?, name, email?, phone?, address?, city?, country?, personeria?, cuil_cuit? }
 ...
 * @desc Update client
 * @access Public
 * @body { code?, client_type?, name?, email?, phone?, address?, city?, country?, personeria?, cuil_cuit?, is_active? }
 */
